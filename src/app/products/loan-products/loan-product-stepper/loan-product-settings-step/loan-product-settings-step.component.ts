...
export class LoanProductSettingsStepComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.loanProductSettingsForm.patchValue({
      ...
      'isInterestStartsAfterGracePeriod': this.loanProductsTemplate.isInterestStartsAfterGracePeriod,
      ...
      'customAllowCreateOrDisburse': this.loanProductsTemplate.customAllowCreateOrDisburse,
      'customAllowCreateOrDisburseSms': this.loanProductsTemplate.customAllowCreateOrDisburseSms,
      'customAllowCollections': this.loanProductsTemplate.customAllowCollections,
      'customAllowCollectionsSms': this.loanProductsTemplate.customAllowCollectionsSms,
      'customAllowDebitNote': this.loanProductsTemplate.customAllowDebitNote,
      'customAllowDebitNoteSms': this.loanProductsTemplate.customAllowDebitNoteSms,
      'customAllowCreditNote': this.loanProductsTemplate.customAllowCreditNote,
      'customAllowCreditNoteSms': this.loanProductsTemplate.customAllowCreditNoteSms,
      'customAllowForgiveness': this.loanProductsTemplate.customAllowForgiveness,
      'customAllowForgivenessSms': this.loanProductsTemplate.customAllowForgivenessSms,
      'customAllowReversalCancellation': this.loanProductsTemplate.customAllowReversalCancellation,
      'customAllowReversalCancellationSms': this.loanProductsTemplate.customAllowReversalCancellationSms,
      'customAllowReferido': this.loanProductsTemplate.customAllowReferido,
      'customAllowReferidoSms': this.loanProductsTemplate.customAllowReferidoSms,
      'customAllowRefinance': this.loanProductsTemplate.customAllowRefinance,
      'customAllowRefinanceSms': this.loanProductsTemplate.customAllowRefinanceSms,
  ...
  createLoanProductSettingsForm() {
    this.loanProductSettingsForm = this.formBuilder.group({
      ...
      'isInterestStartsAfterGracePeriod': [false],
      'useDueForRepaymentsConfigurations': [false],
      ...
      'customAllowCreateOrDisburseSms': [false],
      'customAllowCollections': [false],
      'customAllowCollectionsSms': [false],
      'customAllowDebitNote': [false],
      'customAllowDebitNoteSms': [false],
      'customAllowCreditNote': [false],
      'customAllowCreditNoteSms': [false],
      'customAllowForgiveness': [false],
      'customAllowForgivenessSms': [false],
      'customAllowReferido': [false],
      'customAllowReferidoSms': [false],
      'customAllowRefinance': [false],
      'customAllowRefinanceSms': [false],
