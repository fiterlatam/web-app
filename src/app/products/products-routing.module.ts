...
} from './recurring-deposit-products/view-recurring-deposit-product/view-recurring-deposit-product.component';
...
} from './fixed-deposit-products/create-fixed-deposit-product/create-fixed-deposit-product.component';
...
} from './recurring-deposit-products/create-recurring-deposit-product/create-recurring-deposit-product.component';
...
} from './fixed-deposit-products/view-fixed-deposit-product/view-fixed-deposit-product.component';
...
} from './saving-products/edit-saving-product/saving-product-and-template.resolver';
...
} from './recurring-deposit-products/recurring-deposit-products-template.resolver';
import {
  EditRecurringDepositProductComponent
} from './recurring-deposit-products/edit-recurring-deposit-product/edit-recurring-deposit-product.component';
import {
  RecurringDepositProductAndTemplateResolver
} from './recurring-deposit-products/edit-recurring-deposit-product/recurring-deposit-product-and-template.resolver';
...
} from './fixed-deposit-products/edit-fixed-deposit-product/edit-fixed-deposit-product.component';
import {
  FixedDepositProductAndTemplateResolver
} from './fixed-deposit-products/edit-fixed-deposit-product/fixed-deposit-product-and-template.resolver';
...
} from './manage-delinquency-buckets/delinquency-bucket/delinquency-bucket.component.resolver';
import {
  DelinquencyRangeComponentsResolver
} from './manage-delinquency-buckets/delinquency-range/delinquency-range.component.resolver';
...
} from './manage-delinquency-buckets/delinquency-bucket/create-bucket/create-bucket.component';
...
} from './saving-products/view-saving-product/saving-product-general-tab/saving-product-general-tab.component';
import {
  SavingProductDatatableTabComponent
} from './saving-products/view-saving-product/saving-product-datatable-tab/saving-product-datatable-tab.component';
import {
  FixedDepositGeneralTabComponent
} from './fixed-deposit-products/view-fixed-deposit-product/fixed-deposit-general-tab/fixed-deposit-general-tab.component';
import {
  FixedDepositDatatableTabComponent
} from './fixed-deposit-products/view-fixed-deposit-product/fixed-deposit-datatable-tab/fixed-deposit-datatable-tab.component';
import {
  RecurringDepositGeneralTabComponent
} from './recurring-deposit-products/view-recurring-deposit-product/recurring-deposit-general-tab/recurring-deposit-general-tab.component';
import {
  RecurringDepositDatatableTabComponent
} from './recurring-deposit-products/view-recurring-deposit-product/recurring-deposit-datatable-tab/recurring-deposit-datatable-tab.component';
import {
  ShareProductGeneralTabComponent
} from './share-products/view-share-product/share-product-general-tab/share-product-general-tab.component';
import {
  ShareProductDatatableTabComponent
} from './share-products/view-share-product/share-product-datatable-tab/share-product-datatable-tab.component';
...
} from 'app/system/configurations/global-configurations-tab/global-configurations.resolver';
...
} from './loan-product-parameterization/view-loan-product-parameterization-list/view-loan-product-parameterization-list.component';
import {
  LoanProductParameterizationResolver
} from './loan-product-parameterization/loan-product-parameterization.resolver';
import {
  ViewLoanProductParameterizationComponent
} from './loan-product-parameterization/view-loan-product-parameterization/view-loan-product-parameterization.component';
import {
  LoanProductParameterizationListResolver
} from './loan-product-parameterization/loan-product-parameterization-list.resolver';
import {
  EditLoanProductParameterizationComponent
} from './loan-product-parameterization/edit-loan-product-parameterization/edit-loan-product-parameterization.component';
import {
  ...
  Route.withShell([
      {
        ...
        children: [
          ...
          {
            path: 'loan-products-parameters',
            data: {title: 'Loan Product Parameters', breadcrumb: 'Loan Product Parameterization'},
            children: [
              {
                path: '',
                component: ViewLoanProductParameterizationListComponent,
                resolve: {
                  loanProductParameterizationList: LoanProductParameterizationListResolver
                },
                data: {title: 'Loan Product Parameterization', breadcrumb: 'Loan Product Parameterization'}
              },
              {
                path: 'create',
                component: CreateLoanProductParameterizationComponent,
                data: {title: 'Create Loan Product Parameterization', breadcrumb: 'Create'},
                resolve: {
                  loanProductsTemplate: LoanProductsTemplateResolver,
                  configurations: GlobalConfigurationsResolver
                }
              ...
              {
                path: ':id',
                component: ViewLoanProductParameterizationComponent,
                resolve: {
                  loanProductParameterization: LoanProductParameterizationResolver
                },
                data: {title: 'View Loan Product Parameterization', breadcrumb: 'View', routeParamBreadcrumb: true}
              },
              {
                path: ':id/edit',
                component: EditLoanProductParameterizationComponent,
                resolve: {
                  loanProductParameterization: LoanProductParameterizationResolver
                },
                data: {title: 'Edit Loan Product Parameterization', breadcrumb: 'Edit', routeParamBreadcrumb: true}
              }
            ]
          },
