...
export class RepaymentScheduleTabComponent implements OnInit {
  ...
  displayedColumns: string[] = ['number', 'days', 'date', 'paiddate', 'check', 'balanceOfLoan', 'principalDue', 'interest', 'voluntary.insurance', 'mandatory.insurance', 'aval', 'fees', 'penalties', 'due', 'paid', 'writtenOff', 'inadvance', 'late', 'waived', 'outstanding', 'status'];
