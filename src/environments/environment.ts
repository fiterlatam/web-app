...
export const environment = {
  ...
  fineractPlatformTenantIds: window['env']['fineractPlatformTenantIds'] || 'default, uat',
  ...
  baseApiUrls: window['env']['fineractApiUrls'] ||
    'https://dev.mifos.io,https://demo.mifos.io,https://qa.mifos.io,https://staging.mifos.io,https://mobile.mifos.io,https://demo.fineract.dev,https://localhost:8443,https://sumas-dev.fiter.io',
